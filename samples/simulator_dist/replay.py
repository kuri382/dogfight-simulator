...
from ASRCAISim1.core import Factory # type: ignore
...
def parse_args():
    ...
    parser.add_argument('--movie-dir', default='./results')
...
def main():
    ...
    modelConfig.merge_patch({
        'globPattern': os.path.join(args.movie_dir, args.myagent_id, '**.dat'),
        'outputDir': os.path.join(args.movie_dir, args.myagent_id),
