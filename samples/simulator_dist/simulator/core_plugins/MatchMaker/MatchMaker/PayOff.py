"""!
@package MatchMaker.PayOff

@brief Estimated win rate class based on the pseudocode provided in the AlphaStar paper [1].

@details [1] Vinyals, Oriol, et al. "Grandmaster level in StarCraft II using multi-agent reinforcement learning." Nature 575.7782 (2019): 350-354.
"""
import numpy as np
