...
Eigen::VectorXd RK4(const Eigen::VectorXd& x0,const Time& t0,double dt,std::function<Eigen::VectorXd (const Eigen::VectorXd& x,const Time& t)> deriv){
    Eigen::VectorXd k1=deriv(x0,t0);
    Eigen::VectorXd k2=deriv(x0+dt*0.5*k1, t0+dt*0.5);
    Eigen::VectorXd k3=deriv(x0+dt*0.5*k2, t0+dt*0.5);
    Eigen::VectorXd k4=deriv(x0+dt*k3, t0+dt);
